...
public class NotificationFactorySample extends AbsNotificationFactory
{
	...
	public Notification onGenerateNotification(PushData pushData)
	{
		...
		notificationBuilder.setSmallIcon(pushData.getSmallIconResId());
		...
		if (pushData.getBitmap() != null)
		{
			...
			notificationBuilder.setStyle(new NotificationCompat.BigPictureStyle().bigPicture(pushData.getBitmap()).setSummaryText(getContentFromHtml(pushData.getMessage())));
		}
		else
		{
		...
		{
		      notificationBuilder.setColor(Color.parseColor(pushData.getIconBackgroundColor()));
		}
		
		//support custom icon
		if (null != pushData.getCustomIconBitmap())
		{
		    notificationBuilder.setLargeIcon(pushData.getCustomIconBitmap());
		}
	...
	@Override
	public void onSendDeliveryRequest(boolean local, PushData pushData)
	{
